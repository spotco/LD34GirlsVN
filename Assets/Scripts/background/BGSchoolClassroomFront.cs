...
public class BGSchoolClassroomFront : BGControllerBase {
	...
	public override void i_initialize(GameMain game) {
		...
		_scroll_registry.add_registry_entry(_pre_class_root.transform, 1);
		_scroll_registry.add_registry_entry(_during_class_root.transform, 1);
	...
	public override string get_registered_name() { return "bg_school_classroom_front"; }
	...
	public override void show_background(string name, string key) {
		...
		if (key.Contains("topleft")) {
			_target_scroll_pos = new Vector2(65,-105);
			_target_scale = 1.15f;
		} else {
